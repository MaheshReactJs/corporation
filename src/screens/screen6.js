        ...
        >
            <View style={styles.container}>
                <View style={{ top: 42 }}>
                    ...
                    <View>
                        <Text style={{ fontSize:12, color: '#B4A6A6', textAlign: 'center' }}>
                        Estimated Collection Sheet For The Month Of June 2020
            </Text>
                    </View>
                    ...
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Laon install</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>interset</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Total</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Installment paid no</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                    ...
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Date of Loan</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Loan repaid</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                    ...
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>special loan</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Interest of special loans</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>other loans</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
                    <View style={styles.view_1}>
                        <Text style={styles.text_View}>Interst on other loans</Text>
                        <Text style={styles.text_View}>:</Text>
                        <TextInput style={{width:110}}></TextInput>
                    </View>
